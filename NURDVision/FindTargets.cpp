//include libraries for vision processing and communication via networktables
#include <iostream>
...
//values of the colors reflected off tape
...
//filters out any color besides retroreflective tapes
...
//creates mask to a mat, so we can work with the footage given
...
// Filters out contours that are too small, so that it doesnt pick up tiny rectangles or anything. 
